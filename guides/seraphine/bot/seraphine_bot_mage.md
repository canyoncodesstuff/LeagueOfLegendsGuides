...
###### <em>We can use this as a template, but these really should be auto-generated by an algorithm you write. It would make everything easier and faster.</em>

###### <em>For example, if you are playing Seraphine Bottom you have 4 viable keystone choices. What makes these keystones viable algorithmically? If you take Arcane Comet, you are pretty much guaranteed to take Manaflow Band, Transcendence, Haste Shard, and Adaptive Force Shard. How do we algorithmically determine that and the subsequent rune + item choices?</em>
...
- <img src="../../../images/runes/sorcery/keystones/ArcaneComet.png" width="32" height="32" alt="Arcane Comet" align="absmiddle"> Arcane Comet
  ...
  - <img src="../../../images/items/Shadowflame.png" width="32" height="32" alt="Shadowflame" align="absmiddle"> - If the enemy comp is squishy, you're snowballing, and have the economy for it. Pick up a tear early for either Seraph's. *This will make your comet crit*
