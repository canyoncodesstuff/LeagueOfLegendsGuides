...
###### <em>For example, if you are playing Seraphine Bottom you have 4 viable keystone choice. What makes these keystones viable algorithmically? If you take Arcane Comet, you are pretty much guaranteed to take Manaflow Band, Transcendence, Haste Shard, and Adaptive Force Shard. How do we algorithmically determine that and the subsequent rune + item choices?</em>
